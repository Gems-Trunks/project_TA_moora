   ...
   <div class="login-box" style="width: 400px;">
      <div class="login-logo mb-4">
         <div class="d-flex flex-column align-items-center">
            <img src="{{asset('assets/images/logos/LOGO_GKE.png')}}" alt="logo gke" style="width: 70px; height: auto;" class="mb-3">
            <a href="#" class="text-decoration-none fw-bold" style="font-size: 1rem; line-height: 1.2; color: #333;">
